  ...
  return (
    <div className="mb-3 rounded-card bg-surface p-5 shadow-card">
      ...
      <div className="mt-4 border-t border-hairline pt-2.5 text-[11px] leading-relaxed text-ink-faint">
        ...
        <span className="tabular-nums text-ink">{m0(position.income.expected)}</span>
        {position.income.expectedInflows > 0 && (
          <span className="text-ink-faint"> (incl. {m0(position.income.expectedInflows)} invoiced)</span>
        )}{" "}
        and spend{" "}
