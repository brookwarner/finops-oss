...
import {
  budgetsQuerySchema, setBudgetTargetSchema, createBudgetSchema,
...
export const registry: RouteDoc[] = [
  ...
  { method: "POST", path: "/api/budgets", summary: "Create a net-new budget (+ category if needed)",
    request: { body: createBudgetSchema }, responseType: "CreateBudgetResponse" },
...
export const OUT_OF_SCOPE: string[] = [
  ...
  "sync-accounts", "accounts/revolving", "accounts/emergency-fund", "accounts/visibility",
