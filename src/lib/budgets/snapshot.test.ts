...
function fakeResult(): BudgetComputeResult {
  return {
    ...
    position: { income: { actual: 0, expected: 0, expectedByNow: 0, planned: 0, recentRunRate: 0, expectedInflows: 0 }, expenses: { actual: 0, projected: 0, budget: 0, pending: 0 }, net: { actual: 0, projected: 0, planned: 0 } },
