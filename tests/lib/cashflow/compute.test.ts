...
const args: BuildLinesArgs = {
  ...
  committed: [
    { categoryId: "Power", kind: "ap_amortised", monthlyTarget: 1000, postings: [{ day: 21, amount: 1000 }], spendClass: "essential" },
    { categoryId: "Donations", kind: "ap_amortised", monthlyTarget: 200, postings: [{ day: 22, amount: 200 }], spendClass: "discretionary" },
  ],
  toggles: {},
